...
ip link set br11 addr aa:bb:cc:00:01:65
ip addr add 192.168.11.0/24 dev br11
ip link add vni111 type vxlan local 100.64.0.1 dstport 4789 id 111 nolearning
...
ip link set br100 addr aa:bb:cc:00:02:65
